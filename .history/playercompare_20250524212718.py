...
def gather_transfermarktdata(player_url):
    ...
    etoo_data = gather_transfermarktdata(https://www.transfermarkt.co.uk/samuel-etoo/profil/spieler/4257)
    drogba_data = gather_transfermarktdata(https://www.transfermarkt.co.uk/didier-drogba/profil/spieler/3924)
